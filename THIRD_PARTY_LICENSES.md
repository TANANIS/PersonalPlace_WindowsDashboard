# Personal Place Third-Party License Inventory
...
|---|---|---:|---|
| Node | @adobe/css-tools | 4.5.0 | MIT |
| Node | @asamuzakjp/css-color | 6.0.7 | MIT |
| Node | @asamuzakjp/dom-selector | 8.3.2 | MIT |
| Node | @babel/code-frame | 7.29.7 | MIT |
| Node | @babel/compat-data | 7.29.7 | MIT |
| Node | @babel/core | 7.29.7 | MIT |
| Node | @babel/generator | 7.29.8 | MIT |
| Node | @babel/helper-compilation-targets | 7.29.7 | MIT |
| Node | @babel/helper-globals | 7.29.7 | MIT |
| Node | @babel/helper-module-imports | 7.29.7 | MIT |
| Node | @babel/helper-module-transforms | 7.29.7 | MIT |
| Node | @babel/helper-plugin-utils | 7.29.7 | MIT |
| Node | @babel/helpers | 7.29.7 | MIT |
| Node | @babel/helper-string-parser | 7.29.7 | MIT |
| Node | @babel/helper-validator-identifier | 7.29.7 | MIT |
| Node | @babel/helper-validator-option | 7.29.7 | MIT |
| Node | @babel/parser | 7.29.8 | MIT |
| Node | @babel/plugin-transform-react-jsx-self | 7.29.7 | MIT |
| Node | @babel/plugin-transform-react-jsx-source | 7.29.7 | MIT |
| Node | @babel/runtime | 7.29.7 | MIT |
| Node | @babel/template | 7.29.7 | MIT |
| Node | @babel/traverse | 7.29.8 | MIT |
| Node | @babel/types | 7.29.8 | MIT |
| Node | @bramus/specificity | 2.4.2 | MIT |
| Node | @csstools/color-helpers | 6.1.0 | MIT-0 |
| Node | @csstools/css-calc | 3.3.0 | MIT |
| Node | @csstools/css-color-parser | 4.1.10 | MIT |
| Node | @csstools/css-parser-algorithms | 4.0.0 | MIT |
| Node | @csstools/css-syntax-patches-for-csstree | 1.1.7 | MIT-0 |
| Node | @csstools/css-tokenizer | 4.0.0 | MIT |
| Node | @esbuild/win32-x64 | 0.28.2 | MIT |
| Node | @exodus/bytes | 1.15.1 | MIT |
| Node | @jridgewell/gen-mapping | 0.3.13 | MIT |
| Node | @jridgewell/remapping | 2.3.5 | MIT |
| Node | @jridgewell/resolve-uri | 3.1.2 | MIT |
| Node | @jridgewell/sourcemap-codec | 1.5.5 | MIT |
| Node | @jridgewell/trace-mapping | 0.3.31 | MIT |
| Node | @rolldown/pluginutils | 1.0.0-rc.3 | MIT |
| Node | @rollup/rollup-win32-x64-gnu | 4.62.4 | MIT |
| Node | @rollup/rollup-win32-x64-msvc | 4.62.4 | MIT |
| Node | @standard-schema/spec | 1.1.0 | MIT |
| Node | @tauri-apps/api | 2.11.1 | Apache-2.0 OR MIT |
| Node | @tauri-apps/cli | 2.11.4 | Apache-2.0 OR MIT |
| Node | @tauri-apps/cli-win32-x64-msvc | 2.11.4 | Apache-2.0 OR MIT |
| Node | @tauri-apps/plugin-dialog | 2.7.2 | MIT OR Apache-2.0 |
| Node | @testing-library/dom | 10.4.1 | MIT |
| Node | @testing-library/jest-dom | 7.0.0 | MIT |
| Node | @testing-library/react | 16.3.2 | MIT |
| Node | @testing-library/user-event | 14.6.3 | MIT |
| Node | @types/aria-query | 5.0.4 | MIT |
| Node | @types/babel__core | 7.20.5 | MIT |
| Node | @types/babel__generator | 7.27.0 | MIT |
| Node | @types/babel__template | 7.4.4 | MIT |
| Node | @types/babel__traverse | 7.28.0 | MIT |
| Node | @types/chai | 5.2.3 | MIT |
| Node | @types/deep-eql | 4.0.2 | MIT |
| Node | @types/estree | 1.0.9 | MIT |
| Node | @types/react | 19.2.18 | MIT |
| Node | @types/react-dom | 19.2.4 | MIT |
| Node | @vitejs/plugin-react | 5.2.0 | MIT |
| Node | @vitest/expect | 4.1.10 | MIT |
| Node | @vitest/mocker | 4.1.10 | MIT |
| Node | @vitest/pretty-format | 4.1.10 | MIT |
| Node | @vitest/runner | 4.1.10 | MIT |
| Node | @vitest/snapshot | 4.1.10 | MIT |
| Node | @vitest/spy | 4.1.10 | MIT |
| Node | @vitest/utils | 4.1.10 | MIT |
| Node | ansi-regex | 5.0.1 | MIT |
| Node | ansi-styles | 5.2.0 | MIT |
| Node | aria-query | 5.3.0 | Apache-2.0 |
| Node | aria-query | 5.3.2 | Apache-2.0 |
| Node | assertion-error | 2.0.1 | MIT |
| Node | baseline-browser-mapping | 2.11.13 | Apache-2.0 |
| Node | bidi-js | 1.0.3 | MIT |
| Node | browserslist | 4.28.8 | MIT |
| Node | caniuse-lite | 1.0.30001809 | CC-BY-4.0 |
| Node | chai | 6.2.2 | MIT |
| Node | convert-source-map | 2.0.0 | MIT |
| Node | css.escape | 1.5.1 | MIT |
| Node | css-tree | 3.2.1 | MIT |
| Node | csstype | 3.2.3 | MIT |
| Node | data-urls | 7.0.0 | MIT |
| Node | debug | 4.4.3 | MIT |
| Node | decimal.js | 10.6.0 | MIT |
| Node | dequal | 2.0.3 | MIT |
| Node | dom-accessibility-api | 0.5.16 | MIT |
| Node | dom-accessibility-api | 0.6.3 | MIT |
| Node | electron-to-chromium | 1.5.403 | ISC |
| Node | entities | 8.0.0 | BSD-2-Clause |
| Node | esbuild | 0.28.2 | MIT |
| Node | escalade | 3.2.0 | MIT |
| Node | es-module-lexer | 2.3.1 | MIT |
| Node | estree-walker | 3.0.3 | MIT |
| Node | expect-type | 1.4.0 | Apache-2.0 |
| Node | fdir | 6.5.0 | MIT |
| Node | gensync | 1.0.0-beta.2 | MIT |
| Node | html-encoding-sniffer | 6.0.0 | MIT |
| Node | indent-string | 4.0.0 | MIT |
| Node | is-potential-custom-element-name | 1.0.1 | MIT |
| Node | jsdom | 30.0.1 | MIT |
| Node | jsesc | 3.1.0 | MIT |
| Node | json5 | 2.2.3 | MIT |
| Node | js-tokens | 4.0.0 | MIT |
| Node | lru-cache | 11.5.2 | BlueOak-1.0.0 |
| Node | lru-cache | 5.1.1 | ISC |
| Node | lz-string | 1.5.0 | MIT |
| Node | magic-string | 0.30.21 | MIT |
| Node | mdn-data | 2.27.1 | CC0-1.0 |
| Node | min-indent | 1.0.1 | MIT |
| Node | ms | 2.1.3 | MIT |
| Node | nanoid | 3.3.18 | MIT |
| Node | node-releases | 2.0.53 | MIT |
| Node | obug | 2.1.4 | MIT |
| Node | parse5 | 8.0.1 | MIT |
| Node | pathe | 2.0.3 | MIT |
| Node | picocolors | 1.1.1 | ISC |
| Node | picomatch | 4.0.5 | MIT |
| Node | postcss | 8.5.26 | MIT |
| Node | pretty-format | 27.5.1 | MIT |
| Node | punycode | 2.3.1 | MIT |
| Node | react | 19.2.8 | MIT |
| Node | react-dom | 19.2.8 | MIT |
| Node | react-is | 17.0.2 | MIT |
| Node | react-refresh | 0.18.0 | MIT |
| Node | redent | 3.0.0 | MIT |
| Node | require-from-string | 2.0.2 | MIT |
| Node | rollup | 4.62.4 | MIT |
| Node | saxes | 6.0.0 | ISC |
| Node | scheduler | 0.27.0 | MIT |
| Node | semver | 6.3.1 | ISC |
| Node | siginfo | 2.0.0 | ISC |
| Node | source-map-js | 1.2.1 | BSD-3-Clause |
| Node | stackback | 0.0.2 | MIT |
| Node | std-env | 4.2.0 | MIT |
| Node | strip-indent | 3.0.0 | MIT |
| Node | symbol-tree | 3.2.4 | MIT |
| Node | tinybench | 2.9.0 | MIT |
| Node | tinyexec | 1.3.0 | MIT |
| Node | tinyglobby | 0.2.17 | MIT |
| Node | tinyrainbow | 3.1.1 | MIT |
| Node | tldts | 7.4.10 | MIT |
| Node | tldts-core | 7.4.10 | MIT |
| Node | tough-cookie | 6.0.2 | BSD-3-Clause |
| Node | tr46 | 6.0.0 | MIT |
| Node | typescript | 6.0.3 | Apache-2.0 |
| Node | undici | 8.10.0 | MIT |
| Node | update-browserslist-db | 1.3.0 | MIT |
| Node | vite | 7.3.6 | MIT |
| Node | vitest | 4.1.10 | MIT |
| Node | w3c-xmlserializer | 5.0.0 | MIT |
| Node | webidl-conversions | 8.0.1 | BSD-2-Clause |
| Node | whatwg-mimetype | 5.0.0 | MIT |
| Node | whatwg-url | 16.0.1 | MIT |
| Node | whatwg-url | 17.1.0 | MIT |
| Node | why-is-node-running | 2.3.0 | MIT |
| Node | xmlchars | 2.2.0 | MIT |
| Node | xml-name-validator | 5.0.0 | Apache-2.0 |
| Node | yallist | 3.1.1 | ISC |
...
| Rust | cpufeatures | 0.3.0 | MIT OR Apache-2.0 |
...
| Rust | find-msvc-tools | 0.1.10 | MIT OR Apache-2.0 |
...
| Rust | futures-channel | 0.3.33 | MIT OR Apache-2.0 |
| Rust | futures-core | 0.3.33 | MIT OR Apache-2.0 |
| Rust | futures-executor | 0.3.33 | MIT OR Apache-2.0 |
| Rust | futures-io | 0.3.33 | MIT OR Apache-2.0 |
| Rust | futures-macro | 0.3.33 | MIT OR Apache-2.0 |
| Rust | futures-sink | 0.3.33 | MIT OR Apache-2.0 |
| Rust | futures-task | 0.3.33 | MIT OR Apache-2.0 |
| Rust | futures-util | 0.3.33 | MIT OR Apache-2.0 |
| Rust | gdk | 0.18.2 | MIT |
...
| Rust | jiff | 0.2.35 | Unlicense OR MIT |
| Rust | jiff-core | 0.1.0 | Unlicense OR MIT |
| Rust | jiff-static | 0.2.35 | Unlicense OR MIT |
...
| Rust | js-sys | 0.3.104 | MIT OR Apache-2.0 |
...
| Rust | libredox | 0.1.19 | MIT |
| Rust | libsqlite3-sys | 0.38.2 | MIT |
...
| Rust | portable-atomic-util | 0.2.7 | Apache-2.0 OR MIT |
...
| Rust | quinn-proto | 0.11.16 | MIT OR Apache-2.0 |
...
| Rust | ref-cast | 1.0.26 | MIT OR Apache-2.0 |
| Rust | ref-cast-impl | 1.0.26 | MIT OR Apache-2.0 |
...
| Rust | rustls-webpki | 0.103.13 | ISC |
...
| Rust | serde_with | 3.22.0 | MIT OR Apache-2.0 |
| Rust | serde_with_macros | 3.22.0 | MIT OR Apache-2.0 |
...
| Rust | syn | 3.0.3 | MIT OR Apache-2.0 |
...
| Rust | tauri-plugin-dialog | 2.7.2 | Apache-2.0 OR MIT |
...
| Rust | typed-path | 0.12.3 | MIT OR Apache-2.0 |
...
| Rust | wasm-bindgen | 0.2.127 | MIT OR Apache-2.0 |
| Rust | wasm-bindgen-futures | 0.4.77 | MIT OR Apache-2.0 |
| Rust | wasm-bindgen-macro | 0.2.127 | MIT OR Apache-2.0 |
| Rust | wasm-bindgen-macro-support | 0.2.127 | MIT OR Apache-2.0 |
| Rust | wasm-bindgen-shared | 0.2.127 | MIT OR Apache-2.0 |
